  ...
  return (
    <div className="min-h-screen flex  flex-1 flex-col p-10">
      <header className="flex justify-between w-full mb-10">
        {" "}
        <h1 className="text-2xl font-semibold mb-6">Транзакції</h1>
        <button className="bg-[#0F4F4A] text-white py-3 px-7 rounded-sm cursor-pointer hover:bg-[#198077] transition-all">
          Добавити транзакцію
        </button>
      </header>
